shared_examples_for GroupDocs::Signature::EntityFields do
  ...
  it { should have_aliased_accessor(:reminder_time, :reminderTime)      }
  it { should have_aliased_accessor(:step_expire_time, :stepExpireTime) }
  ...
  it { should have_aliased_accessor(:email_subject, :emailSubject)     }
  it { should have_aliased_accessor(:email_body, :emailBody)           }
